...
export async function sendLaunchEmail({
  ...
  const bodyHtml = `
    <p style="margin: 0 0 14px 0;">Hey ${escapeHtml(customerName || "there")},</p>
    <p style="margin: 0 0 14px 0;">I'm excited to share that the new app i built for <strong>${escapeHtml(venueName)}</strong> has LAUNCHED and i think it's pretty sweet. </p>
    <p style="margin: 0 0 14px 0;">It's the new home for everything you do with the club — booking a bay, access door codes, see upcoming events, peruse the pro shop and make requests, and control your membership — all in one place on your phone.</p>
