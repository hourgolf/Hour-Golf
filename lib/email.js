...
export async function sendLaunchEmail({
  ...
  const bodyHtml = `
    <p style="margin: 0 0 14px 0;">Hey ${escapeHtml(customerName || "there")},</p>
    <p style="margin: 0 0 14px 0;">I'm excited to share that the new app for <strong>${escapeHtml(venueName)}</strong> is READY!</p>
    <p style="margin: 0 0 14px 0;">It's the new home for everything you do with us — booking a bay, access door codes, see upcoming club events, peruse the pro shop, and control your membership — all in one place on your phone.</p>
  ...
  const subject = `The ${venueName} app is HERE!!!`;
