...
export async function sendLaunchEmail({
  ...
  const bodyHtml = `
    <p style="margin: 0 0 14px 0;">Hey ${escapeHtml(customerName || "there")},</p>
    <p style="margin: 0 0 14px 0;">I'm excited to share that the new app i built for <strong>${escapeHtml(venueName)}</strong> has LAUNCHED! I'm pretty excited about this one, and i think you will be too... </p>
