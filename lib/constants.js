...
// Multi-tenant platform: Hour Golf is tenant #1. This UUID is seeded in the
// tenants table by migration 20260417000000_multitenant_foundation.sql and
// is the DEFAULT value for every tenant_id column. Any code path that hasn't
// been updated to resolve tenant from request context falls back to this.
export const HOURGOLF_TENANT_ID = "11111111-1111-4111-8111-111111111111";
