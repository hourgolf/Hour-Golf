...
export default async function handler(req, res) {
  ...
  try {
    ...
    const resp = await fetch(
      `${SUPABASE_URL}/rest/v1/tier_config?tenant_id=eq.${tenantId}&display_order=lt.50&order=display_order&select=tier,monthly_fee,included_hours,overage_rate,pro_shop_discount,display_order,booking_hours_start,booking_hours_end`,
