...
export default function ConfigView({ tierCfg, members, onUpdateTier, onLinkStripe, onSaveTier, onSelectMember, jwt }) {
  ...
  return (
    <div className="content">
      ...
      {/* Discount Codes + Pro Shop Requests moved to the Shop tab
          2026-04-23 — they're shop-operations surfaces, not
          workspace config, and the Shop tab is where operators
          already live when managing inventory and orders. */}
